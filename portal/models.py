...
class SiteSettings(SingletonModel, TimeStampedModel):
    ...
    leader_name = models.CharField(max_length=120, default="Professor Kamoliddin Ergashev")
    leader_title = models.CharField(max_length=120, default="Rector and Chair of the Strategic Council")
